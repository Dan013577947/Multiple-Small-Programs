...
public class main {
	...
	static void call() {
		...
		System.out.println(
				"YOU HAVE THE PERMISSION TO ACCESS CERTAIN PROGRAMS EMBEDED WITHIN A CERTAIN NAMED FUNCTION\n\nYOU WILL CHOOSE THE NUMBER YOU WANT TO ACCESS\n\n");
		...
		while (run == 1) {
			...
			if (counter == 1)
				System.out.println("This is your " + counter + "st attempt.\n");
			else if (counter == 2)
				System.out.println("This is your " + counter + "nd attempt.\n");
			else if (counter == 3)
				System.out.println("This is your " + counter + "rd attempt.\n");
			else
				System.out.println("This is your " + counter + "th attempt.\n");
			...
			if (pick == 1) {
				...
				System.out.println("You should enter (1-11) only, try again");
			{
				for (i = 0; i < 12; i++)
					System.out.println();
	...
	/*
	 * this function one will receive two numbers from the user and add them
	 * together,
	...
	static void two() {
		...
		while (run == 1) {
			System.out
					.print("What letter do you want to display??\nInput: \n\n1 for A\n2 for B\n3 for C\n4 to display ABC: \n");
			letter = in.nextInt();
				...
				for (i = 0; i < 13; i++) {
					for (j = 0; j < 25; j++) {
						if (j == 1 || (i == 0 && (j < 18 && j > 0)) || (j == 18 + i && i < 2) || (j == 20 && (i > 1 && i < 5) ||
								(i == 6 && (j > 0 && j < 19) || (i == 5 && j == 19) || i == 12 && (j > 0 && j < 19) || i == 7 && j == 19
										|| i == 11 && j == 19 ||
										j == 20 && (i > 7 && i < 11)))) {
							System.out.print("*");
						} else
			...
			// LOOP FOR LETTER C
				...
				for (i = 0; i < 13; i++) {
					for (j = 0; j < 25; j++) {
						if (i == 0 && (j > 2 && j < 21) || j == 1 && (i > 1 && i < 11) || j == 2 && i == 1 || j == 2 && i == 11
								|| (j > 2 && j < 21) && i == 12) {
							System.out.print("*");
						} else
							System.out.print(" ");
			...
			// this if else handles the user's response if he/she wants to repeat using the
			// program
			again = in.nextInt();
	...
	static void four() {
		...
		String array_month[] = { "January", "February", "March", "April", "May", "June", "July", "August", "September",
		...
		while (run == 1) {
			...
			else if ((month == 1) || (month == 10) || (month == 12) || (month == 3) || (month == 5)
					|| ((month > 6) && (month < 9))) {
				if ((day > 0) && (day < 30)) {
					if ((year > 0) && (year < 2023)) {
						System.out.println("The date you have entered is: " + array_month[month - 1] + " " + day + " " + year);
	...
	static void five() {
		...
		while (run == 1) {
			...
			System.out.println(
					"Hello everyone, my name is " + name + ". I am now " + age + " years old and my hobby is " + hobby + ".");
			System.out.println("Click Enter to continue...");
